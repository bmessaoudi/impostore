...
export function WelcomeScreen() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 animate-in fade-in duration-700 w-full max-w-sm mx-auto text-center">
      {/* Hero Icon */}
      ...
      <button
        ...
        className="w-full bg-linear-to-r from-noir-red to-red-600 text-white font-bold text-lg py-5 rounded-2xl shadow-[0_0_20px_rgba(230,57,70,0.4)] hover:shadow-[0_0_30px_rgba(230,57,70,0.6)] active:scale-[0.98] transition-all flex items-center justify-center gap-3 group"
      >
